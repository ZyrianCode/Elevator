...
{
    public class InterractWithDoorsButton : Button
    {
        public InterractWithDoorsButton(string name, IInteractableWithDoors newInterractWithDoorsBehaviour, Command command)
        {
            MoveBehaviour = new SendNoMove();
            FeedBackBehaviour = new SendNoCall();
            InteractWithDoorsBehaviour = SetInteractWithDoorsBehaviour(newInterractWithDoorsBehaviour);
            Name = name;
            Command = command;
        }
        ...
        public override FormattedCommand Apply() => InteractWithDoors(Name);
    }
}
