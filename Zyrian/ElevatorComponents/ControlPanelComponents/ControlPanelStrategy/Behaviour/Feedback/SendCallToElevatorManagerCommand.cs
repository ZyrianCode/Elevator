...
{
    public class SendCallToElevatorManagerCommand : IFeedback
    {
        public FormattedCommand Call(string nameOfButton, Command command) => new CommandFormatter().FormateCommand(command, nameOfButton);
    }
}
